 ...
 * FileId: cOTc1mHEwNduq07lsEoUFmw8C92vyM50
 */
...
public class AreaDaoImpl extends BaseDaoImpl<Area, Long> implements AreaDao {
	...
	public Area findOne(String fullName) {
		TypedQuery<Area> query;
		String jpql = "select area from Area area where area.fullName = :fullName ";
		query = entityManager.createQuery(jpql, Area.class).setParameter("fullName", fullName);
