 ...
 * FileId: t4DnriUzXVNom5ReZ8U4IgpBglJDcGhq
 */
...
import com.futengwl.dao.BaseDao;
import com.futengwl.entity.BaseEntity;
import com.futengwl.entity.OrderedEntity;
...
public abstract class BaseDaoImpl<T extends BaseEntity<ID>, ID extends Serializable> implements BaseDao<T, ID> {
	 ...
	 * 别名前缀
	 */
	private static final String ALIAS_PREFIX = "ftshopGeneratedAlias";
