 ...
 * FileId: +Lm2xVTYjTrZaeiyLXhD3GpQufZ4loYS
 */
...
public class Pay99billBankPaymentPlugin extends PaymentPlugin {
	...
	public String getInstallUrl() {
		return "/admin/plugin/pay_99bill_bank_payment/install";
	}

	@Override
	public String getUninstallUrl() {
		return "/admin/plugin/pay_99bill_bank_payment/uninstall";
	}
	...
	public boolean isPaySuccess(PaymentPlugin paymentPlugin, PaymentTransaction paymentTransaction, String paymentDescription, String extra, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		return StringUtils.equals(generateSign(parameterMap), request.getParameter("signMsg")) && StringUtils.equals(getAttribute("partner"), request.getParameter("merchantAcctId")) && StringUtils.equals(request.getParameter("payResult"), "10")
