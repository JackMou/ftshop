 ...
 * FileId: tHNG/AI+vg8MydReIjyhTgSsGgXxAEe4
 */
...
public class Sku extends BaseEntity<Long> {
	 ...
	 */
	@Transient
	public com.futengwl.entity.Store getStore() {
	 ...
	 */
	@Transient
	public BigDecimal getPlatformCommission(com.futengwl.entity.Store.Type type) {
		...
		if (type != null && getProduct() != null && getProduct().getProductCategory() != null) {
			...
			if (com.futengwl.entity.Store.Type.GENERAL.equals(type) && productCategory.getGeneralRate() > 0) {
				commission = getPrice().multiply(new BigDecimal(String.valueOf(productCategory.getGeneralRate())).movePointLeft(2));
			} else if (com.futengwl.entity.Store.Type.SELF.equals(type) && productCategory.getSelfRate() > 0) {
