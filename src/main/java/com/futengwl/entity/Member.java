 ...
 * FileId: L4gbC7WNsDQqqKZDX3QZkVC1r4JJRvhI
 */
...
public class Member extends User {
     ...
     * @return 会员注册项值9
     */
    public int isBaseMember() {
        return isBaseMember;
    }
    public int getIsBaseMember() {
        return isBaseMember;
    }
    /**
     * 设置基础会员
     ...
     *            基础会员
     */
    public void setBaseMember(int isBaseMember) {
        this.isBaseMember = isBaseMember;
    }
    public void setIsBaseMember(int isBaseMember) {
        this.isBaseMember = isBaseMember;
    }
	/**
	 * 获取安全密匙
