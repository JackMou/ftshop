...
import com.futengwl.audit.CreatedDate;
import com.futengwl.audit.LastModifiedDate;
...
/**
 * @title: NotListenerEntityBase
 * @package: com.futengwl.entity
 * @description:
 * @author: hanbin
 * @date: 2018-06-04  9:37
 */
@MappedSuperclass
public class NotListenerEntityBase<ID extends Serializable> implements Serializable {
