 ...
 * FileId: 2hAnnNV5LmilhpG3K6bM3ghkrIrFrd71
 */
package com.futengwl.captcha;
...
public class CaptchaInterceptor extends HandlerInterceptorAdapter {
	 ...
	 * "验证码"类型名称
	 */
	private static final String CAPTCHA_TYPE_PARAMETER_NAME = "captchaType";
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		String captchaType = request.getParameter(CAPTCHA_TYPE_PARAMETER_NAME);
		if (ArrayUtils.contains(setting.getCaptchaTypes(), getCaptchaType()) && !containsIgnoreCase(getNotRequireProtectionRequestMethods(), request.getMethod()) && !captchaService.isValid(captchaId, captcha, captchaType)) {
