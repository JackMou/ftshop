 ...
 * FileId: AlJSWoD068O7GiEKH/E3ZRsjh0fVkUD6
 */
...
public interface OrderService extends BaseService<Order, Long> {
	 ...
	 * @return 订单分页
	 */
	Page<Order> findPage(Date beginDate, Date endDate,Order.Type type, Order.Status status, Store store, Member member, Product product, Boolean isPendingReceive, Boolean isPendingRefunds, Boolean isUseCouponCode, Boolean isExchangePoint, Boolean isAllocatedStock, Boolean hasExpired, Pageable pageable);
	 ...
	 * @return 订单
	 */
	List<Order> create(Order.Type type, Cart cart, Receiver receiver, PaymentMethod paymentMethod, ShippingMethod shippingMethod, CouponCode couponCode, Invoice invoice, BigDecimal balance, String memo, boolean checkAll);
	...
	void saveSpreadIncome(Order order);
}