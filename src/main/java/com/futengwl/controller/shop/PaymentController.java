 ...
 * FileId: B8ogx8e40ZRuncytMUTAccj2TJATL2du
 */
...
import com.futengwl.entity.PaymentTransaction.LineItem;
...
public class PaymentController extends BaseController {
    ...
    public ResponseEntity<?> isPaySuccess(String paymentTransactionSn, @CurrentUser final Member currentUser) throws Exception {
    ...
    public ModelAndView postPay(@PathVariable String paymentTransactionSn, @PathVariable(required = false) String extra, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (isPaySuccess) {
            ...
            //如果顾客为非基础会员，则设置为基础会员
            Member currentUser = paymentTransaction.getOrder().getMember();
            if(0==currentUser.isBaseMember()) {
                currentUser.setBaseMember(1);
