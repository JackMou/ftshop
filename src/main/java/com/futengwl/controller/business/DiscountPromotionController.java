 ...
 * FileId: 4DZyyju7dV5jSOeklq+0sYKM8ZjkLTiE
 */
...
public class DiscountPromotionController extends BaseController {
	 ...
	 */
	@PostMapping("/update")
	public ResponseEntity<?> update(@ModelAttribute("promotionForm") Promotion promotionForm, @ModelAttribute(binding = false) Promotion promotion, Boolean useAmountPromotion, Boolean useNumberPromotion, Long[] memberRankIds, Long[] couponIds, Long[] giftIds, @CurrentStore Store currentStore) {
		if (promotion == null) {
			return Results.UNPROCESSABLE_ENTITY;
		}
