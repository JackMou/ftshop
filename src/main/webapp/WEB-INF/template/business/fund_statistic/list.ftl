...
<head>
	...
	<title>${message("business.fundStatistic.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("business.fundStatistic.list")}</li>
			</ol>
			<form id="fundStatisticForm" action="${base}/business/fund_statistic/data" method="get">
							...
							<div class="col-xs-12 col-sm-3">
								<div class="btn-group">
									<button id="export" class="btn btn-default" type="button">
										...
										${message("business.fundStatistic.export")}
									</button>
									<div class="btn-group">
										<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">
											${message("business.fundStatistic.type")}
									...
									<div class="btn-group">
										<button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">
											${message("business.fundStatistic.period")}
											<span class="caret"></span>
										</button>
