...
<head>
	...
	<title>${message("business.deliveryCenter.edit")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="deliveryCenterForm" class="ajax-form form-horizontal" action="${base}/business/delivery_center/update" method="post">
				<input name="deliveryCenterId" type="hidden" value="${deliveryCenter.id}">
				<div class="panel panel-default">
					<div class="panel-heading">${message("business.deliveryCenter.edit")}</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<div class="checkbox">
									...
									<input id="isDefault" name="isDefault" type="checkbox" value="true"[#if deliveryCenter.isDefault] checked[/#if]>
