...
<head>
	...
	<title>${message("business.deliveryCenter.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/business/delivery_center/add" data-redirect-url="${base}/business/delivery_center/list">
									...
									<tbody>
										[#list page.content as deliveryCenter]
											<tr>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/business/delivery_center/edit?deliveryCenterId=${deliveryCenter.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
