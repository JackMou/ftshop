...
<head>
	...
	<title>${message("business.storeProductCategory.add")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="storeProductCategoryForm" class="ajax-form form-horizontal" action="${base}/business/store_product_category/save" method="post">
				<div class="panel panel-default">
					<div class="panel-heading">${message("business.storeProductCategory.add")}</div>
