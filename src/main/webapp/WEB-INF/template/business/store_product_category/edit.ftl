...
<head>
	...
	<title>${message("business.storeProductCategory.edit")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="storeProductCategoryForm" class="ajax-form form-horizontal" action="${base}/business/store_product_category/update" method="post">
				<input name="storeProductCategoryId" type="hidden" value="${storeProductCategory.id}">
				<div class="panel panel-default">
					<div class="panel-heading">${message("business.storeProductCategory.edit")}</div>
					<div class="panel-body">
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="name">${message("StoreProductCategory.name")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="name" name="name" class="form-control" type="text" value="${storeProductCategory.name}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label">${message("StoreProductCategory.parent")}:</label>
							<div class="col-xs-9 col-sm-4">
