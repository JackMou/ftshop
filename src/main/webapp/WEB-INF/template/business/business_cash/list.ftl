...
<head>
	...
	<title>${message("business.businessCash.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
									...
									<tbody>
										[#list page.content as businessCash]
											<tr[#if !businessCash_has_next] class="last"[/#if]>
												...
												<td>
													<span title="${businessCash.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${businessCash.createdDate}</span>
												</td>
											</tr>
										[/#list]
									</tbody>
