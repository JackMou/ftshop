...
<head>
	...
	<title>${message("business.messageGroup.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				}).on("success.ftshop.delete", function(event) {
									...
									<tbody>
										[#list page.content as messageGroup]
											<tr>
												...
												<td>
													<span title="${messageGroup.lastModifiedDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${messageGroup.lastModifiedDate}</span>
												</td>
												<td>
