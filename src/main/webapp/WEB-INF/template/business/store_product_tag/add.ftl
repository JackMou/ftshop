...
<head>
	...
	<title>${message("business.storeProductTag.add")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="storeProductTagForm" class="ajax-form form-horizontal" action="${base}/business/store_product_tag/save" method="post">
				<div class="panel panel-default">
					<div class="panel-heading">${message("business.storeProductTag.add")}</div>
