...
<head>
	...
	<title>${message("business.storeProductTag.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/business/store_product_tag/add" data-redirect-url="${base}/business/store_product_tag/list">
									...
									<tbody>
										[#list page.content as storeProductTag]
											<tr>
												...
												<td>
													<span title="${storeProductTag.memo}">${abbreviate(storeProductTag.memo, 30, "...")}</span>
												</td>
												<td>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/business/store_product_tag/edit?storeProductTagId=${storeProductTag.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
