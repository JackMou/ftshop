...
<head>
	...
	<title>${message("business.shippingMethod.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
											...
											<tr>
												...
												<td>
													[#if defaultFreightConfig.firstPrice ??]
														${currency(defaultFreightConfig.firstPrice, true)}
													[#else]
														--
													[/#if]
												</td>
												<td>
													[#if defaultFreightConfig.continuePrice ??]
														${currency(defaultFreightConfig.continuePrice, true)}
													[#else]
														--
													[/#if]
												</td>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/business/shipping_method/edit?shippingMethodId=${shippingMethod.id}" title="${message("business.shippingMethod.defaultFreightConfig")}" data-toggle="tooltip" data-redirect-url>
														<i class="iconfont icon-deliver"></i>
													</a>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/business/area_freight_config/list?shippingMethodId=${shippingMethod.id}" title="${message("business.shippingMethod.areaFreightConfig")}" data-toggle="tooltip">
