...
<aside id="mainSidebar" class="main-sidebar">
	...
	<div id="mainSidebarPanelGroup" class="panel-group">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="panel-title">
					<a href="#productPanelCollapse" data-toggle="collapse" data-parent="#mainSidebarPanelGroup"[#if .main_template_name?matches("business/index.*|business/product/.*|business/stock/.*|business/product_notify/.*|business/consultation/.*|business/review/.*")] aria-expanded="true"[/#if]>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="panel-title">
					<a href="#promotionPanelCollapse" data-toggle="collapse" data-parent="#mainSidebarPanelGroup"[#if .main_template_name?matches("business/discount_promotion/.*|business/full_reduction_promotion/.*|business/coupon/.*")] aria-expanded="true"[/#if]>
			...
			<div id="promotionPanelCollapse" class="panel-collapse collapse[#if .main_template_name?matches("business/discount_promotion/.*|business/full_reduction_promotion/.*|business/coupon/.*")] in[/#if]">
				<div class="panel-body">
					<ul class="list-group">
						[@promotion_plugin promotionPluginId = "discountPromotionPlugin"]
							[#if promotionPlugin.isEnabled]
								<li class="list-group-item[#if .main_template_name?matches("business/discount_promotion/.*")] active[/#if]">
						...
						[@promotion_plugin promotionPluginId = "fullReductionPromotionPlugin"]
							[#if promotionPlugin.isEnabled]
								<li class="list-group-item[#if .main_template_name?matches("business/full_reduction_promotion/.*")] active[/#if]">
							...
							[/#if]
						[/@promotion_plugin]
						<li class="list-group-item[#if .main_template_name?matches("business/coupon/.*")] active[/#if]">
