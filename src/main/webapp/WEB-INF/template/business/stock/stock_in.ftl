...
<head>
	...
	<title>${message("business.stock.stockIn")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="stockForm" class="ajax-form form-horizontal" action="${base}/business/stock/stock_in" method="post">
				<div class="panel panel-default">
					<div class="panel-heading">${message("business.stock.stockIn")}</div>
					<div class="panel-body">
						...
						<div class="[#if !sku.sn?has_content]hidden-element[/#if] form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="quantity">${message("business.stock.stockInQuantity")}:</label>
							<div class="col-xs-9 col-sm-4">
