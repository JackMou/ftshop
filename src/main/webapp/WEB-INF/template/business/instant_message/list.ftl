...
<head>
	...
	<title>${message("business.instantMessage.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/business/instant_message/add" data-redirect-url="${base}/business/instant_message/list">
									...
									<tbody>
										[#list page.content as instantMessage]
											<tr>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/business/instant_message/edit?instantMessageId=${instantMessage.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
