...
<head>
	...
	<title>${message("business.instantMessage.edit")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="instantMessageForm" class="ajax-form form-horizontal" action="${base}/business/instant_message/update" method="post">
				<input name="instantMessageId" type="hidden" value="${instantMessage.id}">
				<div class="panel panel-default">
					<div class="panel-heading">${message("business.instantMessage.edit")}</div>
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="account" name="account" class="form-control" type="text" value="${instantMessage.account}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
