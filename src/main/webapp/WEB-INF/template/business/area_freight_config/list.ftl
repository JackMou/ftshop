...
<head>
	...
	<title>${message("business.areaFreightConfig.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/business/area_freight_config/add?shippingMethodId=${shippingMethod.id}" data-redirect-url>
									...
									<tbody>
										[#list page.content as areaFreightConfig]
											<tr>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/business/area_freight_config/edit?areaFreightConfigId=${areaFreightConfig.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
