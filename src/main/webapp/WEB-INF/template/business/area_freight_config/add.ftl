...
<head>
	...
	<title>${message("business.areaFreightConfig.add")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="areaFreightConfigForm" class="ajax-form form-horizontal" action="${base}/business/area_freight_config/save" method="post">
				<input name="shippingMethodId" type="hidden" value="${shippingMethod.id}">
				<div class="panel panel-default">
					<div class="panel-heading">${message("business.areaFreightConfig.add")}</div>
