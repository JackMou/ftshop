...
<head>
	...
	<title>${message("business.review.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
									...
									<tbody>
										[#list page.content as review]
											<tr>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/business/review/reply?reviewId=${review.id}" title="${message("business.review.reply")}" data-toggle="tooltip">
