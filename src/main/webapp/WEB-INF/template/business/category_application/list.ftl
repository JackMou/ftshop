...
<head>
	...
	<title>${message("business.categoryApplication.list")} - Powered By FTSHOP</title>
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/business/category_application/add" data-redirect-url="${base}/business/category_application/list">
