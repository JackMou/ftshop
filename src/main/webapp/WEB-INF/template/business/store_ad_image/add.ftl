...
<head>
	...
	<title>${message("business.storeAdImage.add")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="storeAdImageForm" class="ajax-form form-horizontal" action="${base}/business/store_ad_image/save" method="post">
				<div class="panel panel-default">
					<div class="panel-heading">${message("business.storeAdImage.add")}</div>
