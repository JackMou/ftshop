...
<head>
	...
	<title>${message("business.storeAdImage.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/business/store_ad_image/add" data-redirect-url="${base}/business/store_ad_image/list">
									...
									<tbody>
										[#list page.content as storeAdImage]
											<tr>
												...
												<td>${storeAdImage.title}</td>
												<td>
													<span title="${storeAdImage.url}">${abbreviate(storeAdImage.url, 30, "...")}</span>
												</td>
												<td>${storeAdImage.order}</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/business/store_ad_image/edit?storeAdImageId=${storeAdImage.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
