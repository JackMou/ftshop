...
<head>
	...
	<title>${message("business.deliveryTemplate.edit")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				$content.data("summernote").layoutInfo.editable.css("background", "url(${deliveryTemplate.background}) 0px 0px no-repeat");
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="deliveryTemplateForm" class="ajax-form form-horizontal" action="${base}/business/delivery_template/update" method="post">
				<input name="deliveryTemplateId" type="hidden" value="${deliveryTemplate.id}">
				<div class="panel panel-default">
					<div class="panel-heading">${message("business.deliveryTemplate.edit")}</div>
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<textarea id="content" name="content" rows="5">${deliveryTemplate.content}</textarea>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<div class="checkbox">
									...
									<input id="isDefault" name="isDefault" type="checkbox" value="true"[#if deliveryTemplate.isDefault] checked[/#if]>
