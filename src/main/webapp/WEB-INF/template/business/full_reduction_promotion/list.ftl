...
<head>
	...
	<title>${message("business.fullReductionPromotion.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/business/full_reduction_promotion/add" data-redirect-url="${base}/business/full_reduction_promotion/list">
									...
									<tbody>
										[#list page.content as promotion]
											<tr>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/business/full_reduction_promotion/edit?promotionId=${promotion.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
