...
<head>
	...
	<title>${message("business.fullReductionPromotion.buy")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<a class="btn btn-primary" href="${base}/business/full_reduction_promotion/list">${message("PayConfirmModal.complete")}</a>
			...
			<form id="fullReductionPromotionForm" class="form-horizontal" action="${base}/payment" method="post" target="_blank">
				...
				<input name="rePayUrl" type="hidden" value="${base}/business/full_reduction_promotion/buy">
				<div class="panel panel-default">
					<div class="panel-heading">${message("business.fullReductionPromotion.buy")}</div>
					<div class="panel-body">
						[#if currentStore.endDate??]
							[#if currentStore.fullReductionPromotionEndDate??]
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label">${message("Store.fullReductionPromotionEndDate")}:</label>
									<div class="col-xs-9 col-sm-4">
										<p class="form-control-static text-orange">${currentStore.fullReductionPromotionEndDate?string("yyyy-MM-dd HH:mm:ss")}</p>
									</div>
								</div>
							[/#if]
							<div class="form-group">
								<label class="col-xs-3 col-sm-2 control-label">${message("PromotionPlugin.price")}:</label>
								<div class="col-xs-9 col-sm-4">
									<p class="form-control-static">${message("business.fullReductionPromotion.price", currency(promotionPlugin.price, true, true))}</p>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-3 col-sm-2 control-label item-required" for="months">${message("business.fullReductionPromotion.months")}:</label>
								<div class="col-xs-9 col-sm-4">
									<div class="spinner input-group input-group-sm" title="${message("business.fullReductionPromotion.monthsTitle")}" data-trigger="spinner" data-toggle="tooltip">
							...
							<div class="form-group">
								<label class="col-xs-3 col-sm-2 control-label">${message("business.fullReductionPromotion.amount")}:</label>
								<div class="col-xs-9 col-sm-4">
							...
							[#if promotionPlugin.price > 0]
								<div id="feeItem" class="hidden-element form-group">
									<label class="col-xs-3 col-sm-2 control-label">${message("business.fullReductionPromotion.fee")}:</label>
									<div class="col-xs-9 col-sm-4">
								...
								[#if currentUser.availableBalance > 0]
									<div class="form-group">
										<label class="col-xs-3 col-sm-2 control-label">${message("business.fullReductionPromotion.useBalance")}:</label>
										<div class="col-xs-9 col-sm-4">
											<div class="checkbox">
