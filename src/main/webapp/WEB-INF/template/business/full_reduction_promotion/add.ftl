...
<head>
	...
	<title>${message("business.fullReductionPromotion.add")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="fullReductionPromotionForm" class="ajax-form form-horizontal" action="${base}/business/full_reduction_promotion/save" method="post">
						...
						<div class="tab-content">
							<div id="base" class="tab-pane active">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<div class="checkbox checkbox-inline">
											<input id="useAmountPromotion" name="useAmountPromotion" type="checkbox" value="true">
											<label for="useAmountPromotion">${message("business.fullReductionPromotion.useAmountPromotion")}</label>
										</div>
										<div class="checkbox checkbox-inline">
											<input id="useNumberPromotion" name="useNumberPromotion" type="checkbox" value="true">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<select id="giftIds" name="giftIds" class="form-control" title="${message("business.fullReductionPromotion.giftTitle")}" multiple></select>
									</div>
								</div>
								<div class="form-group">
