...
<head>
	...
	<title>${message("business.order.edit")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
						...
						<div class="tab-content">
							<div id="orderInfo" class="tab-pane active">
								<div class="row">
									...
									<div class="col-xs-12 col-sm-6">
										<div class="form-group">
											<label class="col-xs-3 col-sm-4 control-label" for="invoiceTaxNumber">${message("Invoice.taxNumber")}:</label>
											<div class="col-xs-9 col-sm-4">
