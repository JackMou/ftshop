...
<head>
	...
	<title>${message("business.discountPromotion.add")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="discountPromotionForm" class="ajax-form form-horizontal" action="${base}/business/discount_promotion/save" method="post">
					...
					<div class="panel-body">
						...
						<div class="tab-content">
							<div id="base" class="tab-pane active">
								...
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label" for="discount">${message("Promotion.discount")}:</label>
									<div class="col-xs-9 col-sm-4" title="${message("business.discountPromotion.discountNote")}" data-toggle="tooltip">
										<input id="discount" name="discount" class="form-control" type="text" maxlength="9">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<div class="checkbox checkbox-inline">
											...
											<input id="isFreeShipping" name="isFreeShipping" type="checkbox" value="true">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<select id="giftIds" name="giftIds" class="form-control" title="${message("business.discountPromotion.giftTitle")}" multiple></select>
									</div>
								</div>
								<div class="form-group">
