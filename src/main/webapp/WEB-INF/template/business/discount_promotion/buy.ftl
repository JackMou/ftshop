...
<head>
	...
	<title>${message("business.discountPromotion.buy")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<a class="btn btn-primary" href="${base}/business/discount_promotion/list">${message("PayConfirmModal.complete")}</a>
			...
			<form id="discountPromotionForm" class="form-horizontal" action="${base}/payment" method="post" target="_blank">
				...
				<input name="rePayUrl" type="hidden" value="${base}/business/discount_promotion/buy">
				<div class="panel panel-default">
					<div class="panel-heading">${message("business.discountPromotion.buy")}</div>
					<div class="panel-body">
						[#if currentStore.endDate??]
							[#if currentStore.discountPromotionEndDate??]
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label">${message("Store.discountPromotionEndDate")}:</label>
									<div class="col-xs-9 col-sm-4">
										<p class="form-control-static text-orange">${currentStore.discountPromotionEndDate?string("yyyy-MM-dd HH:mm:ss")}</p>
									</div>
								</div>
							[/#if]
							<div class="form-group">
								...
								<div class="col-xs-9 col-sm-4">
									<p class="form-control-static">${message("business.discountPromotion.price", currency(promotionPlugin.price, true, true))}</p>
								</div>
							</div>
							<div class="form-group">
								<label class="col-xs-3 col-sm-2 control-label item-required" for="months">${message("business.discountPromotion.months")}:</label>
								<div class="col-xs-9 col-sm-4">
									<div class="spinner input-group input-group-sm" title="${message("business.discountPromotion.monthsTitle")}" data-trigger="spinner" data-toggle="tooltip">
							...
							<div class="form-group">
								<label class="col-xs-3 col-sm-2 control-label">${message("business.discountPromotion.amount")}:</label>
								<div class="col-xs-9 col-sm-4">
							...
							[#if promotionPlugin.price > 0]
								<div id="feeItem" class="hidden-element form-group">
									<label class="col-xs-3 col-sm-2 control-label">${message("business.discountPromotion.fee")}:</label>
									<div class="col-xs-9 col-sm-4">
								...
								[#if currentUser.availableBalance > 0]
									<div class="form-group">
										<label class="col-xs-3 col-sm-2 control-label">${message("business.discountPromotion.useBalance")}:</label>
										<div class="col-xs-9 col-sm-4">
											<div class="checkbox">
