...
<head>
	...
	<title>${message("business.discountPromotion.edit")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="discountPromotionForm" class="ajax-form form-horizontal" action="${base}/business/discount_promotion/update" method="post">
							...
							<div id="base" class="tab-pane active">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4" title="${message("business.discountPromotion.discountNote")}" data-toggle="tooltip">
										<input id="discount" name="discount" class="form-control" type="text" value="${promotion.discount}" maxlength="9">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<select id="giftIds" name="giftIds" class="form-control" title="${message("business.discountPromotion.giftTitle")}" multiple>
