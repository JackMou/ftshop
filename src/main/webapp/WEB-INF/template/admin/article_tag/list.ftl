...
<head>
	...
	<title>${message("admin.articleTag.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.articleTag.list")}</li>
			</ol>
			<form action="${base}/admin/article_tag/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/article_tag/add" data-redirect-url="${base}/admin/article_tag/list">
									...
									<tbody>
										[#list page.content as articleTag]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${articleTag.id}">
														<label></label>
													</div>
												</td>
												<td>${articleTag.name}</td>
												<td>
													<span title="${articleTag.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${articleTag.createdDate}</span>
												</td>
												<td>${articleTag.order}</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/article_tag/edit?id=${articleTag.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
