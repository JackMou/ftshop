...
<head>
	...
	<title>${message("admin.ad.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.ad.list")}</li>
			</ol>
			<form action="${base}/admin/ad/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/ad/add" data-redirect-url="${base}/admin/ad/list">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="adPosition">
									...
									<tbody>
										[#list page.content as ad]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${ad.id}">
														<label></label>
													</div>
												</td>
												<td>${ad.title}</td>
												...
												<td>
													[#if ad.beginDate??]
														<span title="${ad.beginDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${ad.beginDate}</span>
													[#else]
														-
													[/#if]
												</td>
												<td>
													[#if ad.endDate??]
														<span title="${ad.endDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${ad.endDate}</span>
													[#else]
														-
													[/#if]
												</td>
												<td>${ad.order}</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/ad/edit?id=${ad.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
