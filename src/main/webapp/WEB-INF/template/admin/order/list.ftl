...
<head>
	...
	<title>${message("admin.order.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$export.click(function () {
                        ...
                        var form = $('<form method="get" action="${base}/admin/order/download"></form>');
                        form.appendTo('body');
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9 col-sm-7">
                                    <div class="input-group" data-provide="datetimerangepicker" >
                                        <input id="beginDate" name="beginDate" data-date-format="YYYY-MM-DD 00:00:00" class="form-control"  type="text" [#if beginDate??] value="${beginDate?string("yyyy-MM-dd HH:mm:ss")}"[/#if]>
                                        <span class="input-group-addon">-</span>
                                        <input id="endDate" name="endDate"  data-date-format="YYYY-MM-DD 23:59:59" class="form-control" type="text" [#if endDate??] value="${endDate?string("yyyy-MM-dd HH:mm:ss")}"[/#if]>
                                    </div>
                                </div>
                            </div>
                        </div>
