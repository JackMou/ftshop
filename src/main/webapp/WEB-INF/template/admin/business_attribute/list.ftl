...
<head>
	...
	<title>${message("admin.businessAttribute.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.businessAttribute.list")}</li>
			</ol>
			<form action="${base}/admin/business_attribute/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/business_attribute/add" data-redirect-url="${base}/admin/business_attribute/list">
									...
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="name">
												${message("BusinessAttribute.name")}
										...
										<th>
											<a href="javascript:;" data-order-property="isRequired">
												${message("BusinessAttribute.isRequired")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="isEnabled">
												${message("BusinessAttribute.isEnabled")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
									...
									<tbody>
										[#list page.content as businessAttribute]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${businessAttribute.id}">
														<label></label>
													</div>
												</td>
												<td>${businessAttribute.name}</td>
												<td>${message("BusinessAttribute.Type." + businessAttribute.type)}</td>
												<td>
												...
												<td>
													[#if businessAttribute.isEnabled]
														<i class="text-green iconfont icon-check"></i>
													[#else]
														<i class="text-red iconfont icon-close"></i>
													[/#if]
												</td>
												<td>${businessAttribute.order}</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/business_attribute/edit?id=${businessAttribute.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
