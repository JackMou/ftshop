...
<head>
	...
	<title>${message("admin.shippingMethod.add")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.shippingMethod.add")}</li>
			</ol>
			<form id="shippingMethodForm" class="ajax-form form-horizontal" action="${base}/admin/shipping_method/save" method="post">
				<div class="panel panel-default">
					<div class="panel-heading">${message("admin.shippingMethod.add")}</div>
							...
							<div class="col-xs-9 col-sm-10">
								[#list paymentMethods as paymentMethod]
									<div class="checkbox checkbox-inline">
										<input id="paymentMethod_${paymentMethod.id}" name="paymentMethodIds" type="checkbox" value="${paymentMethod.id}">
