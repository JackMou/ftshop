...
<head>
	...
	<title>${message("admin.shippingMethod.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.shippingMethod.list")}</li>
			</ol>
			<form action="${base}/admin/shipping_method/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/shipping_method/add" data-redirect-url="${base}/admin/shipping_method/list">
									...
									<tbody>
										[#list page.content as shippingMethod]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${shippingMethod.id}">
														<label></label>
													</div>
												</td>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/shipping_method/edit?id=${shippingMethod.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
