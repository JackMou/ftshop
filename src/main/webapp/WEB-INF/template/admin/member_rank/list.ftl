...
<head>
	...
	<title>${message("admin.memberRank.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.memberRank.list")}</li>
			</ol>
			<form action="${base}/admin/member_rank/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/member_rank/add" data-redirect-url="${base}/admin/member_rank/list">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										<th>
											<div class="checkbox">
												<input type="checkbox" data-toggle="checkAll" data-target="input[name='ids']:enabled">
												<label></label>
											</div>
										</th>
										<th>
											<a href="javascript:;" data-order-property="name">
												${message("MemberRank.name")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="scale">
												${message("MemberRank.scale")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="amount">
												${message("MemberRank.amount")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="isDefault">
												${message("MemberRank.isDefault")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
									...
									<tbody>
										[#list page.content as memberRank]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${memberRank.id}"[#if memberRank.isDefault] disabled[/#if]>
														<label></label>
													</div>
												</td>
												<td>${memberRank.name}</td>
												<td>${memberRank.scale}</td>
												<td>${currency(memberRank.amount, true)}</td>
												<td>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/member_rank/edit?id=${memberRank.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
