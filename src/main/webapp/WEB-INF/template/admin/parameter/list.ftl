...
<head>
	...
	<title>${message("admin.parameter.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.parameter.list")}</li>
			</ol>
			<form action="${base}/admin/parameter/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/parameter/add" data-redirect-url="${base}/admin/parameter/list">
									...
									<div class="input-group-btn">
										<button class="btn btn-default" type="button" data-toggle="dropdown">
											[#switch page.searchProperty]
												[#default]
													<span>${message("Parameter.group")}</span>
											[/#switch]
											<span class="caret"></span>
										</button>
										<ul class="dropdown-menu">
											<li[#if !page.searchProperty?? || page.searchProperty == "group"] class="active"[/#if] data-search-property="group">
												<a href="javascript:;">${message("Parameter.group")}</a>
											</li>
										</ul>
									</div>
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="group">
									...
									<tbody>
										[#list page.content as parameter]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${parameter.id}">
														<label></label>
													</div>
												</td>
												<td>${parameter.group}</td>
												<td>${parameter.productCategory.name}</td>
												<td>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/parameter/edit?id=${parameter.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
														<i class="iconfont icon-write"></i>
													</a>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/parameter/add?sampleId=${parameter.id}" title="${message("common.copy")}" data-toggle="tooltip" data-redirect-url="${base}/admin/parameter/list">
