...
<head>
	...
	<title>${message("admin.parameter.add")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.parameter.add")}</li>
			</ol>
			<form id="parameterForm" class="ajax-form form-horizontal" action="${base}/admin/parameter/save" method="post">
				<div class="panel panel-default">
					<div class="panel-heading">${message("admin.parameter.add")}</div>
					<div class="panel-body">
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="group">${message("Parameter.group")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="group" name="group" class="form-control" type="text" maxlength="200">
							</div>
						</div>
						<div class="form-group">
