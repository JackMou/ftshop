...
<head>
	...
	<title>${message("admin.role.add")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10 permissions">
								<div class="checkbox checkbox-inline">
									<input id="promotion" name="permissions" type="checkbox" value="admin:promotion">
									<label for="promotion">${message("admin.role.promotion")}</label>
								</div>
								<div class="checkbox checkbox-inline">
									<input id="coupon" name="permissions" type="checkbox" value="admin:coupon">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10 permissions">
								...
								<div class="checkbox checkbox-inline">
									<input id="promotionPlugin" name="permissions" type="checkbox" value="admin:promotionPlugin">
