...
<head>
	...
	<title>${message("admin.role.edit")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10 permissions">
								<div class="checkbox checkbox-inline">
									<input id="promotion" name="permissions" type="checkbox" value="admin:promotion"[#if role.permissions?seq_contains("admin:promotion")] checked[/#if]>
									<label for="promotion">${message("admin.role.promotion")}</label>
								</div>
								<div class="checkbox checkbox-inline">
									<input id="coupon" name="permissions" type="checkbox" value="admin:coupon"[#if role.permissions?seq_contains("admin:coupon")] checked[/#if]>
									<label for="coupon">${message("admin.role.coupon")}</label>
								</div>
								<div class="checkbox checkbox-inline">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10 permissions">
								...
								<div class="checkbox checkbox-inline">
									<input id="promotionPlugin" name="permissions" type="checkbox" value="admin:promotionPlugin"[#if role.permissions?seq_contains("admin:promotionPlugin")] checked[/#if]>
									<label for="promotionPlugin">${message("admin.role.promotionPlugin")}</label>
								</div>
								<div class="checkbox checkbox-inline">
