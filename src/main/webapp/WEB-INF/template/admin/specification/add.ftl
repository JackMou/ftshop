...
<head>
	...
	<title>${message("admin.specification.add")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.specification.add")}</li>
			</ol>
			<form id="specificationForm" class="ajax-form form-horizontal" action="${base}/admin/specification/save" method="post">
				<div class="panel panel-default">
					<div class="panel-heading">${message("admin.specification.add")}</div>
