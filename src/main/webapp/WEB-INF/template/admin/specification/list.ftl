...
<head>
	...
	<title>${message("admin.specification.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.specification.list")}</li>
			</ol>
			<form action="${base}/admin/specification/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/specification/add" data-redirect-url="${base}/admin/specification/list">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>${message("Specification.options")}</th>
										<th>
									...
									<tbody>
										[#list page.content as specification]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${specification.id}">
														<label></label>
													</div>
												</td>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/specification/edit?id=${specification.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
														<i class="iconfont icon-write"></i>
													</a>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/specification/add?sampleId=${specification.id}" title="${message("common.copy")}" data-toggle="tooltip" data-redirect-url="${base}/admin/specification/list">
