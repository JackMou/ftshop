...
<head>
	...
	<title>${message("admin.specification.edit")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
			...
			<div class="form-group">
				<div class="col-xs-9 col-sm-4 col-xs-offset-3 col-sm-offset-2">
					<div class="input-group">
						<span class="input-group-addon">${message("Specification.options")}</span>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.specification.edit")}</li>
			</ol>
			<form id="specificationForm" class="ajax-form form-horizontal" action="${base}/admin/specification/update" method="post">
				<input name="id" type="hidden" value="${specification.id}">
				<div class="panel panel-default">
					<div class="panel-heading">${message("admin.specification.edit")}</div>
					<div class="panel-body">
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="name">${message("Specification.name")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="name" name="name" class="form-control" type="text" value="${specification.name}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label">${message("Specification.productCategory")}:</label>
							<div class="col-xs-9 col-sm-4">
								<p class="form-control-static">${specification.productCategory.name}</p>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-xs-9 col-sm-4 col-xs-offset-3 col-sm-offset-2">
								<button id="addOption" class="btn btn-default" type="button">
									...
									${message("admin.specification.addOption")}
								</button>
							</div>
						</div>
						<div id="option"></div>
