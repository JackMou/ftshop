...
<head>
	...
	<title>${message("admin.plugin.weixinH5Payment.setting")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				var $weixinH5PaymentForm = $("#weixinH5PaymentForm");
				
				// 表单验证
				$weixinH5PaymentForm.validate({
					rules: {
			...
			<form id="weixinH5PaymentForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/weixin_h5_payment/update" method="post">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="appId">${message("admin.plugin.weixinH5Payment.appId")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="appId" name="appId" class="form-control" type="text" value="${pluginConfig.getAttribute("appId")}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="mchId">${message("admin.plugin.weixinH5Payment.mchId")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="mchId" name="mchId" class="form-control" type="text" value="${pluginConfig.getAttribute("mchId")}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="apiKey">${message("admin.plugin.weixinH5Payment.apiKey")}:</label>
							<div class="col-xs-9 col-sm-4">
