...
<head>
	...
	<title>${message("admin.plugin.fullReductionPromotion.setting")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.plugin.fullReductionPromotion.setting")}</li>
			</ol>
			<form id="fullReductionPromotionForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/full_reduction_promotion/update" method="post">
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="price">${message("PromotionPlugin.price")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="price" name="price" class="form-control" type="text" value="${pluginConfig.getAttribute("price")}" maxlength="16">
							</div>
						</div>
						<div class="form-group">
