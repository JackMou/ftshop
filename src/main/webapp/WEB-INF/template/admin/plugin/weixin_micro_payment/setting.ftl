...
<head>
	...
	<title>${message("admin.plugin.weixinMicroPayment.setting")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.plugin.weixinMicroPayment.setting")}</li>
			</ol>
			<form id="weixinPublicPaymentForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/weixin_micro_payment/update" method="post">
