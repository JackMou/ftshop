...
<head>
	...
	<title>${message("admin.plugin.discountPromotion.setting")} - Powered By FTSHOP</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.plugin.discountPromotion.setting")}</li>
			</ol>
			<form id="discountPromotionForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/discount_promotion/update" method="post">
