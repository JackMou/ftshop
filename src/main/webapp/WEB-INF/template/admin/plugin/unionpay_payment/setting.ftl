...
<head>
	...
	<title>${message("admin.plugin.unionpayPayment.setting")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				var $unionpayPaymentForm = $("#unionpayPaymentForm");
				var $keyFile = $("#keyFile");
			...
			<form id="unionpayPaymentForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/unionpay_payment/update" method="post" enctype="multipart/form-data">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="merchantId">${message("admin.plugin.unionpayPayment.merchantId")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="merchantId" name="merchantId" class="form-control" type="text" value="${pluginConfig.getAttribute("merchantId")}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label[#if !pluginConfig.getAttribute("key")?has_content] item-required[/#if]">${message("admin.plugin.unionpayPayment.keyFile")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="keyFile" name="keyFile" type="file">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label" for="keyPassword">${message("admin.plugin.unionpayPayment.keyPassword")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="keyPassword" name="keyPassword" class="form-control" type="text" maxlength="16">
							</div>
						</div>
						<div class="form-group">
