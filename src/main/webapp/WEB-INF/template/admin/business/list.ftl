...
<head>
	...
	<title>${message("admin.business.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.business.list")}</li>
			</ol>
			<form action="${base}/admin/business/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/business/add" data-redirect-url="${base}/admin/business/list">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="legalPerson">
										...
										<th>${message("admin.business.status")}</th>
									...
									<tbody>
										[#list page.content as business]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${business.id}">
														<label></label>
													</div>
												</td>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/business/view?id=${business.id}" title="${message("common.view")}" data-toggle="tooltip">
														<i class="iconfont icon-search"></i>
													</a>
