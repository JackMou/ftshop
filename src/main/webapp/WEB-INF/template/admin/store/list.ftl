...
<head>
	...
	<title>${message("admin.store.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="storeRank">
												${message("Store.storeRank")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="storeCategory">
									...
									<tbody>
										[#list page.content as store]
											<tr>
												...
												<td>
													<span title="${store.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${store.createdDate}</span>
												</td>
												<td>
													[#if store.endDate??]
														<span title="${store.endDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${store.endDate}</span>
													[#else]
														-
													[/#if]
												</td>
