...
<head>
	...
	<title>${message("admin.distributor.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.distributor.list")}</li>
			</ol>
			<form action="${base}/admin/distributor/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/distributor/add" data-redirect-url="${base}/admin/distributor/list">
									...
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="member">
												${message("Distributor.member")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="parent">
												${message("Distributor.parent")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
									...
									<tbody>
										[#list page.content as distributor]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${distributor.id}">
														<label></label>
													</div>
												</td>
												<td>${distributor.member.username}</td>
												<td>[#if distributor.parent!=null]${distributor.parent.member.username}[#else]--[/#if]</td>
												<td>
													<span title="${distributor.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${distributor.createdDate}</span>
												</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/distributor/edit?id=${distributor.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
