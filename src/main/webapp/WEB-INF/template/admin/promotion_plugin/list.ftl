...
<head>
	...
	<title>${message("admin.promotionPlugin.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>${message("PromotionPlugin.price")}</th>
										...
										<tr>
											...
											<td>
												[#if promotionPlugin.price??]
													${currency(promotionPlugin.price, true)}
												[/#if]
											</td>
											<td>
