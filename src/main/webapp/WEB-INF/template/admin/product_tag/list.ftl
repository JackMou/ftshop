...
<head>
	...
	<title>${message("admin.productTag.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.productTag.list")}</li>
			</ol>
			<form action="${base}/admin/product_tag/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/product_tag/add" data-redirect-url="${base}/admin/product_tag/list">
									...
									<tbody>
										[#list page.content as productTag]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${productTag.id}">
														<label></label>
													</div>
												</td>
												<td>${productTag.name}</td>
												<td>
													<span title="${productTag.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${productTag.createdDate}</span>
												</td>
												<td>${productTag.order}</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/product_tag/edit?id=${productTag.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
