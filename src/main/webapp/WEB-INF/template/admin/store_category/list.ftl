...
<head>
	...
	<title>${message("admin.storeCategory.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.storeCategory.list")}</li>
			</ol>
			<form action="${base}/admin/store_category/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/store_category/add" data-redirect-url="${base}/admin/store_category/list">
									...
									<tbody>
										[#list page.content as storeCategory]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${storeCategory.id}">
														<label></label>
													</div>
												</td>
