...
<head>
	...
	<title>${message("admin.consultation.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.consultation.list")}</li>
			</ol>
			<form action="${base}/admin/consultation/list" method="get">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>${message("admin.consultation.isReply")}</th>
										<th>
									...
									<tbody>
										[#list page.content as consultation]
											<tr>
												...
												<td>
													[#if consultation.replyConsultations]
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/consultation/edit?id=${consultation.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
