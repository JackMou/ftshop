...
<head>
	...
	<title>${message("admin.index.title")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					<tr>
						...
						<td>
							${systemName}
							[#--<a class="text-gray" href="http://www.futengwl.com" target="_blank">[${message("admin.index.license")}]</a>--]
						</td>
