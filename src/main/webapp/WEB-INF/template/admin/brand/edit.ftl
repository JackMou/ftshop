...
<head>
	...
	<title>${message("admin.brand.edit")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10">
								<textarea name="introduction" class="form-control" data-provide="editor">${brand.introduction}</textarea>
							</div>
						</div>
					</div>
