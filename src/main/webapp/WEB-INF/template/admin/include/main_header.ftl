	...
	<ul class="nav pull-right">
		...
		<li class="dropdown">
			...
			[#--<ul class="dropdown-menu dropdown-menu-right">--]
				[#--<li>--]
					[#--<a href="http://www.futengwl.com" target="_blank">${message("admin.mainHeader.official")}</a>--]
				[#--</li>--]
				[#--<li>--]
					[#--<a href="http://www.futengwl.com/about.html" target="_blank">${message("admin.mainHeader.about")}</a>--]
				[#--</li>--]
			[#--</ul>--]
		</li>
		<li>
	...
	[#escape x as x?js_string]
		...
		$().ready(function() {
			...
			$mainHeaderLogout.click(function() {
				$document.trigger("loggedOut.ftshop.user", $.getCurrentUser());
			});
