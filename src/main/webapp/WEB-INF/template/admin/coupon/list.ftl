...
<head>
	...
	<title>${message("admin.coupon.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.coupon.list")}</li>
			</ol>
			<form action="${base}/admin/coupon/list" method="get">
									...
									<div class="input-group-btn">
										<button class="btn btn-default" type="button" data-toggle="dropdown">
											[#switch page.searchProperty]
												[#case "store.name"]
													<span>${message("Coupon.store")}</span>
													[#break /]
												[#default]
										...
										<ul class="dropdown-menu">
											...
											<li[#if page.searchProperty == "store.name"] class="active"[/#if] data-search-property="store.name">
												<a href="javascript:;">${message("Coupon.store")}</a>
											</li>
										</ul>
									</div>
