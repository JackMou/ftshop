...
<head>
	...
	<title>${message("admin.orderReturns.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.orderReturns.list")}</li>
			</ol>
			<form action="${base}/admin/order_returns/list" method="get">
									...
									<div class="input-group-btn">
										<button class="btn btn-default" type="button" data-toggle="dropdown">
											[#switch page.searchProperty]
												[#case "trackingNo"]
													<span>${message("OrderReturns.trackingNo")}</span>
													[#break /]
												[#case "shipper"]
													<span>${message("OrderReturns.shipper")}</span>
													[#break /]
												[#case "area"]
													<span>${message("OrderReturns.area")}</span>
													[#break /]
												[#case "address"]
													<span>${message("OrderReturns.address")}</span>
													[#break /]
												[#case "zipCode"]
													<span>${message("OrderReturns.zipCode")}</span>
													[#break /]
												[#case "phone"]
													<span>${message("OrderReturns.phone")}</span>
													[#break /]
												[#default]
													<span>${message("OrderReturns.sn")}</span>
											[/#switch]
											<span class="caret"></span>
										</button>
										<ul class="dropdown-menu">
											<li[#if !page.searchProperty?? || page.searchProperty == "sn"] class="active"[/#if] data-search-property="sn">
												<a href="javascript:;">${message("OrderReturns.sn")}</a>
											</li>
											<li[#if page.searchProperty == "trackingNo"] class="active"[/#if] data-search-property="trackingNo">
												<a href="javascript:;">${message("OrderReturns.trackingNo")}</a>
											</li>
											<li[#if page.searchProperty == "shipper"] class="active"[/#if] data-search-property="shipper">
												<a href="javascript:;">${message("OrderReturns.shipper")}</a>
											</li>
											<li[#if page.searchProperty == "area"] class="active"[/#if] data-search-property="area">
												<a href="javascript:;">${message("OrderReturns.area")}</a>
											</li>
											<li[#if page.searchProperty == "address"] class="active"[/#if] data-search-property="address">
												<a href="javascript:;">${message("OrderReturns.address")}</a>
											</li>
											<li[#if page.searchProperty == "zipCode"] class="active"[/#if] data-search-property="zipCode">
												<a href="javascript:;">${message("OrderReturns.zipCode")}</a>
											</li>
											<li[#if page.searchProperty == "phone"] class="active"[/#if] data-search-property="phone">
												<a href="javascript:;">${message("OrderReturns.phone")}</a>
											</li>
										</ul>
									</div>
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="shipper">
									...
									<tbody>
										[#list page.content as returns]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${returns.id}">
														<label></label>
													</div>
												</td>
												<td>${returns.sn}</td>
												...
												<td>
													<span title="${returns.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${returns.createdDate}</span>
												</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/order_returns/view?id=${returns.id}" title="${message("common.view")}" data-toggle="tooltip">
														<i class="iconfont icon-search"></i>
													</a>
												</td>
											</tr>
