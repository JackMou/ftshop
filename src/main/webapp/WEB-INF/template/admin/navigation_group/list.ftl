...
<head>
	...
	<title>${message("admin.navigationGroup.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.navigationGroup.list")}</li>
			</ol>
			<form action="${base}/admin/navigation_group/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/navigation_group/add" data-redirect-url="${base}/admin/navigation_group/list">
					...
					<div class="panel-body">
						<div class="table-responsive">
							<table class="table table-hover">
								...
								<tbody>
									[#list page.content as navigationGroup]
										<tr>
											<td>
												<div class="checkbox">
													<input name="ids" type="checkbox" value="${navigationGroup.id}">
													<label></label>
												</div>
											</td>
											<td>${navigationGroup.name}</td>
											<td>
												<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/navigation_group/edit?id=${navigationGroup.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
