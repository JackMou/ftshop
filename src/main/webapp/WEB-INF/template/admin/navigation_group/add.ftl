...
<head>
	...
	<title>${message("admin.navigationGroup.add")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.navigationGroup.add")}</li>
			</ol>
			<form id="navigationGroupForm" class="ajax-form form-horizontal" action="${base}/admin/navigation_group/save" method="post">
				<div class="panel panel-default">
					<div class="panel-heading">${message("admin.navigationGroup.add")}</div>
