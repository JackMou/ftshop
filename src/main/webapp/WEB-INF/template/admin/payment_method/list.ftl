...
<head>
	...
	<title>${message("admin.paymentMethod.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.paymentMethod.list")}</li>
			</ol>
			<form action="${base}/admin/payment_method/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/payment_method/add" data-redirect-url="${base}/admin/payment_method/list">
									...
									<tbody>
										[#list page.content as paymentMethod]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${paymentMethod.id}">
														<label></label>
													</div>
												</td>
												<td>${paymentMethod.name}</td>
												<td>${message("PaymentMethod.Type." + paymentMethod.type)}</td>
												<td>${message("PaymentMethod.Method." + paymentMethod.method)}</td>
												<td>${paymentMethod.order}</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/payment_method/edit?id=${paymentMethod.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
