...
<head>
	...
	<title>${message("admin.paymentMethod.edit")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10">
								<textarea name="content" class="form-control" data-provide="editor">${paymentMethod.content}</textarea>
							</div>
						</div>
					</div>
