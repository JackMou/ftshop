...
<head>
	...
	<title>${message("admin.member.edit")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
                                        ...
                                        <div class="checkbox checkbox-inline">
                                            ...
                                            <input id="isBMember" name="isBMember" type="checkbox" value="true"[#if 1==member.isBaseMember()] checked[/#if]>
