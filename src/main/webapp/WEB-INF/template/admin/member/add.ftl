...
<head>
	...
	<title>${message("admin.member.add")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$().ready(function() {
                ...
                // 美容院选择
                $beautyId.selectpicker({
                    liveSearch: true
                }).ajaxSelectPicker({
                    ajax: {
                        url: "${base}/admin/member/beauty_select",
                        type: "GET",
                        data: function() {
                            return {
                                keyword: "{{{q}}}"
						...
						<div class="tab-content">
							<div id="base" class="tab-pane active">
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label item-required" for="username">${message("Member.mobile")}:</label>
								...
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<div class="checkbox">
                                            ...
                                            <br/>
                                            <input name="_isBMember" type="hidden" value="false">
                                            <input id="isBMember" name="isBMember" type="checkbox" value="true" checked>
                                            <label for="isBMember">${message("User.isBaseMember")}</label>
										</div>
									</div>
								</div>
                                <div class="form-group">
                                    <label class="col-xs-3 col-sm-2 control-label">美容院:</label>
                                    <div class="col-xs-9 col-sm-4">
                                        <select id="beautyId" name="beautyId" class="form-control" title="查找美容院"></select>
                                    </div>
                                </div>
							</div>
							[#if memberAttributes?has_content]
