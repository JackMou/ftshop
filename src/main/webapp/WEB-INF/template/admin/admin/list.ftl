...
<head>
	...
	<title>${message("admin.admin.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form action="${base}/admin/admin/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/admin/add" data-redirect-url="${base}/admin/admin/list">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="department">
												${message("Admin.department")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="lastLoginIp">
												${message("User.lastLoginIp")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="lastLoginDate">
										...
										<th>${message("admin.admin.status")}</th>
									...
									<tbody>
										[#list page.content as admin]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${admin.id}">
														<label></label>
													</div>
												</td>
												...
												<td>
													[#if admin.lastLoginDate??]
														<span title="${admin.lastLoginDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${admin.lastLoginDate}</span>
													[#else]
														-
													[/#if]
												</td>
												<td>
													<span title="${admin.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${admin.createdDate}</span>
												</td>
												<td>
													[#if !admin.isEnabled]
														<span class="text-red">${message("admin.admin.disabled")}</span>
													[#elseif admin.isLocked]
														<span class="text-red">${message("admin.admin.locked")}</span>
													[#else]
														<span class="text-green">${message("admin.admin.normal")}</span>
													[/#if]
												</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/admin/edit?id=${admin.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
