...
<head>
	...
	<title>${message("admin.admin.add")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
				...
				$adminForm.validate({
					rules: {
						username: {
							...
							notAllNumber: true,
							remote: {
								url: "${base}/admin/admin/check_username",
								cache: false
							}
						},
						password: {
						...
						email: {
							...
							email: true,
							remote: {
								url: "${base}/admin/admin/check_email",
								cache: false
							}
						},
						mobile: {
							...
							mobile: true,
							remote: {
								url: "${base}/admin/admin/check_mobile",
								cache: false
							}
						},
						roleIds: "required"
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.admin.add")}</li>
			</ol>
			<form id="adminForm" class="ajax-form form-horizontal" action="${base}/admin/admin/save" method="post">
						...
						<div class="tab-content">
							<div id="base" class="tab-pane active">
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label item-required" for="username">${message("Admin.username")}:</label>
									<div class="col-xs-9 col-sm-4">
										<input id="username" name="username" class="form-control" type="text" maxlength="20">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label item-required" for="password">${message("Admin.password")}:</label>
									<div class="col-xs-9 col-sm-4">
										<input id="password" name="password" class="form-control" type="password" maxlength="20" autocomplete="off">
									</div>
								</div>
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label item-required" for="rePassword">${message("admin.admin.rePassword")}:</label>
									<div class="col-xs-9 col-sm-4">
									...
									<div class="col-xs-9 col-sm-10">
										[#list roles as role]
											<div class="checkbox checkbox-inline">
												<input id="role_${role.id}" name="roleIds" type="checkbox" value="${role.id}">
							...
							<div id="profile" class="tab-pane">
								<div class="form-group">
									...
									<div class="col-xs-9 col-sm-4">
										<input id="department" name="department" class="form-control" type="text" maxlength="200">
									</div>
								</div>
								<div class="form-group">
