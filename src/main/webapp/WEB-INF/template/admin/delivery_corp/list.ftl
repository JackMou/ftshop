...
<head>
	...
	<title>${message("admin.deliveryCorp.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.deliveryCorp.list")}</li>
			</ol>
			<form action="${base}/admin/delivery_corp/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/delivery_corp/add" data-redirect-url="${base}/admin/delivery_corp/list">
									...
									<tbody>
										[#list page.content as deliveryCorp]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${deliveryCorp.id}">
														<label></label>
													</div>
												</td>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/delivery_corp/edit?id=${deliveryCorp.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
