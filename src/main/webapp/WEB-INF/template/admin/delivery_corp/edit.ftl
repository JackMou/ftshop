...
<head>
	...
	<title>${message("admin.deliveryCorp.edit")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.deliveryCorp.edit")}</li>
			</ol>
			<form id="deliveryCorpForm" class="ajax-form form-horizontal" action="${base}/admin/delivery_corp/update" method="post">
				<input name="id" type="hidden" value="${deliveryCorp.id}">
				<div class="panel panel-default">
					<div class="panel-heading">${message("admin.deliveryCorp.edit")}</div>
					<div class="panel-body">
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="name">${message("DeliveryCorp.name")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="name" name="name" class="form-control" type="text" value="${deliveryCorp.name}" maxlength="200" autocomplete="off">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label" for="url">${message("DeliveryCorp.url")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="url" name="url" class="form-control" type="text" value="${deliveryCorp.url}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4" title="${message("admin.deliveryCorp.codeTitle")}" data-toggle="tooltip">
								<input id="code" name="code" class="form-control" type="text" value="${deliveryCorp.code}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label" for="order">${message("common.order")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="order" name="order" class="form-control" type="text" value="${deliveryCorp.order}" maxlength="9">
							</div>
						</div>
					</div>
