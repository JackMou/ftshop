...
<head>
	...
	<title>${message("admin.deliveryTemplate.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.deliveryTemplate.list")}</li>
			</ol>
			<form action="${base}/admin/delivery_template/list" method="get">
