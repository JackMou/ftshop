...
<head>
	...
	<title>${message("admin.orderPayment.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.orderPayment.list")}</li>
			</ol>
			<form action="${base}/admin/order_payment/list" method="get">
									...
									<div class="input-group-btn">
										<button class="btn btn-default" type="button" data-toggle="dropdown">
											[#switch page.searchProperty]
												[#case "account"]
													<span>${message("OrderPayment.account")}</span>
													[#break /]
												[#case "payer"]
													<span>${message("OrderPayment.payer")}</span>
													[#break /]
												[#default]
													<span>${message("OrderPayment.sn")}</span>
											[/#switch]
											<span class="caret"></span>
										</button>
										<ul class="dropdown-menu">
											<li[#if !page.searchProperty?? || page.searchProperty == "sn"] class="active"[/#if] data-search-property="sn">
												<a href="javascript:;">${message("OrderPayment.sn")}</a>
											</li>
											<li[#if page.searchProperty == "account"] class="active"[/#if] data-search-property="account">
												<a href="javascript:;">${message("OrderPayment.account")}</a>
											</li>
											<li[#if page.searchProperty == "payer"] class="active"[/#if] data-search-property="payer">
												<a href="javascript:;">${message("OrderPayment.payer")}</a>
											</li>
										</ul>
									</div>
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="fee">
												${message("OrderPayment.fee")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="payer">
									...
									<tbody>
										[#list page.content as orderPayment]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${orderPayment.id}">
														<label></label>
													</div>
												</td>
												...
												<td>${orderPayment.payer}</td>
												<td>${orderPayment.order.sn}</td>
												<td>
													<span title="${orderPayment.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${orderPayment.createdDate}</span>
												</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/order_payment/view?id=${orderPayment.id}" title="${message("common.view")}" data-toggle="tooltip">
														<i class="iconfont icon-search"></i>
													</a>
												</td>
											</tr>
