...
<head>
	...
	<title>${message("admin.attribute.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.attribute.list")}</li>
			</ol>
			<form action="${base}/admin/attribute/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/attribute/add" data-redirect-url="${base}/admin/attribute/list">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>${message("Attribute.options")}</th>
										<th>
									...
									<tbody>
										[#list page.content as attribute]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${attribute.id}">
														<label></label>
													</div>
												</td>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/attribute/edit?id=${attribute.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
														<i class="iconfont icon-write"></i>
													</a>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/attribute/add?sampleId=${attribute.id}" title="${message("common.copy")}" data-toggle="tooltip" data-redirect-url="${base}/admin/attribute/list">
