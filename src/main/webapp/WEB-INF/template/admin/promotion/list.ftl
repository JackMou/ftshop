...
<head>
	...
	<title>${message("admin.promotion.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.promotion.list")}</li>
			</ol>
			<form action="${base}/admin/promotion/list" method="get">
									...
									<div class="input-group-btn">
										<button class="btn btn-default" type="button" data-toggle="dropdown">
											[#switch page.searchProperty]
												[#case "title"]
													...
													[#break /]
												[#case "store"]
													<span>${message("Promotion.store")}</span>
													[#break /]
												[#default]
										...
										<ul class="dropdown-menu">
											...
											<li[#if page.searchProperty == "store.name"] class="active"[/#if] data-search-property="store.name">
												<a href="javascript:;">${message("Promotion.store")}</a>
											</li>
										</ul>
									</div>
