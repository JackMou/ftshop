...
<head>
	...
	<title>${message("admin.adPosition.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.adPosition.list")}</li>
			</ol>
			<form action="${base}/admin/ad_position/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/ad_position/add" data-redirect-url="${base}/admin/ad_position/list">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="width">
												${message("AdPosition.width")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="height">
									...
									<tbody>
										[#list page.content as adPosition]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${adPosition.id}">
														<label></label>
													</div>
												</td>
												...
												<td>
													[#if adPosition.description??]
														<span title="${adPosition.description}">${abbreviate(adPosition.description, 30, "...")}</span>
													[/#if]
												</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/ad_position/edit?id=${adPosition.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
