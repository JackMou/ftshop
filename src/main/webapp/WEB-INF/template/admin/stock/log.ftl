...
<head>
	...
	<title>${message("admin.stock.log")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.stock.log")}</li>
			</ol>
			<form action="${base}/admin/stock/log" method="get">
											...
											<tr>
												...
												<td>
													...
													[#if stockLog.sku.specifications?has_content]
														<span class="text-gray">[${stockLog.sku.specifications?join(", ")}]</span>
													[/#if]
												</td>
												...
												<td>
													[#if stockLog.memo??]
														<span title="${stockLog.memo}">${abbreviate(stockLog.memo, 30, "...")}</span>
													[/#if]
												</td>
												<td>
													<span title="${stockLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${stockLog.createdDate}</span>
												</td>
											</tr>
										[/#list]
									</tbody>
