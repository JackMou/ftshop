...
<head>
	...
	<title>${message("admin.storeRank.list")} [#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.storeRank.list")}</li>
			</ol>
			<form action="${base}/admin/store_rank/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/store_rank/add" data-redirect-url="${base}/admin/store_rank/list">
									...
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="name">
												${message("StoreRank.name")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="serviceFee">
												${message("StoreRank.serviceFee")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
											<a href="javascript:;" data-order-property="quantity">
										...
										<th>
											<a href="javascript:;" data-order-property="isAllowRegister">
												${message("StoreRank.isAllowRegister")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
									...
									<tbody>
										[#list page.content as storeRank]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${storeRank.id}">
														<label></label>
													</div>
												</td>
												<td>${storeRank.name}</td>
												<td>${currency(storeRank.serviceFee, true)}</td>
												<td>${storeRank.quantity}</td>
												<td>
													<span title="${storeRank.memo}">${abbreviate(storeRank.memo, 30, "...")}</span>
												</td>
												<td>
												...
												<td>${storeRank.order}</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/store_rank/edit?id=${storeRank.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
