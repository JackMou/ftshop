...
<head>
	...
	<title>${message("admin.article.edit")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="articleForm" class="ajax-form form-horizontal" action="${base}/admin/article/update" method="post">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-10">
								[#list articleTags as articleTag]
									<div class="checkbox checkbox-inline">
										<input id="articleTag_${articleTag.id}" name="articleTagIds" type="checkbox" value="${articleTag.id}"[#if article.articleTags?seq_contains(articleTag)] checked[/#if]>
