...
<head>
	...
	<title>${message("admin.article.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form action="${base}/admin/article/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/article/add" data-redirect-url="${base}/admin/article/list">
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="articleCategory">
									...
									<tbody>
										[#list page.content as article]
											<tr>
												...
												<td>
													<span title="${article.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${article.createdDate}</span>
												</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/article/edit?id=${article.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
														<i class="iconfont icon-write"></i>
													</a>
													[#if article.isPublication]
														<a class="btn btn-default btn-xs btn-icon" href="${base}${article.path}" title="${message("common.view")}" data-toggle="tooltip" target="_blank">
															<i class="iconfont icon-search"></i>
														</a>
													[#else]
														<button class="disabled btn btn-default btn-xs btn-icon" type="button" title="${message("admin.article.notPublished")}" data-toggle="tooltip">
															<i class="iconfont icon-search"></i>
														</button>
													[/#if]
												</td>
