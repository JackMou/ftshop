...
<head>
	...
	<title>${message("admin.navigation.list")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form action="${base}/admin/navigation/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/navigation/add" data-redirect-url="${base}/admin/navigation/list">
									...
									<div class="input-group-btn">
										...
										<ul class="dropdown-menu">
											<li[#if !page.searchProperty?? || page.searchProperty == "name"] class="active"[/#if] data-search-property="name">
												<a href="javascript:;">${message("Navigation.name")}</a>
											</li>
										</ul>
									</div>
									...
									<tbody>
										[#list page.content as navigation]
											<tr>
												<td>
													<div class="checkbox">
														<input name="ids" type="checkbox" value="${navigation.id}">
														<label></label>
													</div>
												</td>
												...
												<td>${navigation.navigationGroup.name}</td>
												<td>${navigation.order}</td>
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/navigation/edit?id=${navigation.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
