...
<head>
	...
	<title>${message("common.error.notFound")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="media">
			<div class="media-left media-middle">
				<img class="media-object" src="${base}/resources/common/images/error_icon.png" alt="${message("common.error.notFound")}">
			</div>
