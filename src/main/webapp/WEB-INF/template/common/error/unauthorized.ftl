...
<head>
	...
	<title>${message("common.error.unauthorized")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
	...
	<main>
		<div class="media">
			<div class="media-left media-middle">
				<img class="media-object" src="${base}/resources/common/images/error_icon.png" alt="${message("common.error.unauthorized")}">
			</div>
			<div class="media-body media-middle">
				<h2 class="media-heading">${message("common.error.title")}</h2>
				<p class="text-red-light">${errorMessage!message("common.error.unauthorized")}</p>
				<p>
