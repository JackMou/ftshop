		...
		[#escape x as x?js_string]
			...
			$().ready(function() {
                ...
                $sendCode.on('click', function() {
                    ...
                    $.get('${base}/member/login/authCode?username=' + $username.val(), function(res) {
                        if(res === 'success') {
                            sending = true;
							...
							<div class="panel-body">
								...
								<div class="form-group">
									<div class="input-group">
										...
										<input id="password" name="password" class="form-control" type="text" maxlength="200" placeholder="${message("member.login.passwordPlaceholder")}" autocomplete="off">
