...
<head>
	...
	<title>${message("member.memberDeposit.recharge")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
				...
				[#if paymentPlugins??]
					<div class="panel panel-default">
						...
						<div class="panel-footer text-center">
                            ...
                            <a class="btn btn-default" href="javascript:;" data-action="back">${message("common.back")}</a>
						</div>
					</div>
				[/#if]
			</form>
