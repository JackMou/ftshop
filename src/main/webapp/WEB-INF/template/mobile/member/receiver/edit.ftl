...
<head>
	...
	<title>${message("member.receiver.edit")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="member">
	<header class="header-default" data-spy="scrollToFixed">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-xs-10">
					<h5>${message("member.receiver.edit")}</h5>
				</div>
			</div>
		</div>
	</header>
	<main>
		<div class="container-fluid">
			<form id="inputForm" action="${base}/member/receiver/update" method="post">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="" for="zipCode">${message("Receiver.zipCode")}</label>
