...
<head>
	...
	<title>${message("shop.productCategory.title")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
...
<body class="shop product-category" onload="loaded();">
	...
	<footer class="footer-default" data-spy="scrollToFixed" data-bottom="0">
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-3">
					<a href="[#if storeId??]${base}/store/${storeId}[#else]${base}/[/#if]">
						<i class="iconfont icon-home center-block"></i>
						<span class="center-block">${message("shop.footer.home")}</span>
					</a>
				</div>
				<div class="col-xs-3">
					<a class="active" href="[#if storeId??]${base}/product_category?storeId=${storeId}[#else]${base}/product_category[/#if]">
                        <i class="iconfont icon-sort center-block"></i>
						<span class="center-block">${message("shop.footer.productCategory")}</span>
					</a>
				</div>
				<div class="col-xs-3">
					<a href="[#if storeId??]${base}/cart/list?storeId=${storeId}[#else]${base}/cart/list[/#if]">
				...
				<div class="col-xs-3">
					<a href="[#if storeId??]${base}/member/index?storeId=${storeId}[#else]${base}/member/index[/#if]">
