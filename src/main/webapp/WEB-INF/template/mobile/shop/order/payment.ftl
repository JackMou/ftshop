...
<head>
	...
	<title>${message("shop.order.payment")}[#if showPowered] - Powered By FTSHOP[/#if]</title>
		...
		<div class="container-fluid">
			...
			[#if online]
				[#if paymentPlugins?has_content]
					...
					<div class="panel-body">
						<button class="btn btn-lg btn-flat btn-block" onclick='location.href="/"'>稍后支付</button>
					</div>													
				[/#if]
			[#else]
				[#noautoesc]
