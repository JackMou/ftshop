...
<body class="shop store-index">
	...
	<main>
		<div class="container-fluid">
			<div class="media" style="background: url('${base}/resources/mobile/shop/images/456.jpg');background-position: center 60%;">
	...
	<footer class="footer-default" data-spy="scrollToFixed" data-bottom="0">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-xs-3">
					<a href="${base}/cart/list?storeId=${store.getId()}">
						<i class="iconfont icon-cart center-block relative">
                            <span class="shop-count">5</span>
                        </i>
						<span class="center-block">${message("shop.footer.cart")}</span>
					</a>
				</div>
				<div class="col-xs-3">
					<a href="${base}/member/index?storeId=${store.getId()}">
